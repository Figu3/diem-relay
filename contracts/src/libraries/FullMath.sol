...
library FullMath {
    ...
    function mulDiv(uint256 a, uint256 b, uint256 denominator) internal pure returns (uint256 result) {
        ...
        // Uniswap V3 modular arithmetic requires unchecked — Newton-Raphson
        // iterations and twos-complement tricks intentionally wrap around 2**256.
        unchecked {
