...
| **RevenueSplitter v3** | `0x213c8d7434E2ae7AA1C392767c5120778D413215` |
...
2. **`RevenueSplitter.distribute()`** — split the next 24h batch from RevenueSplitter v3 20/80 into platform Safe + sDIEM v2 rewards. Skipped silently if balance below `minAmount` or cooldown not elapsed.
